...
public class HttpRequest {
    ...
    public static HttpsURLConnection getConnect(String urlStr) throws IOException{
        return getConnect(urlStr, null);
    }

    public static HttpsURLConnection getConnect(String urlStr, String cookies)throws IOException{
        URL url = new URL(urlStr);
        HttpsURLConnection conn = (HttpsURLConnection)url.openConnection();
        conn.setRequestMethod("GET");
        conn.setRequestProperty("User-Agent", "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.80 Safari/537.36");
    ...
    public static byte[] downloadDataFromUrl(String urlStr)  throws IOException{
        HttpsURLConnection conn = getConnect(urlStr);
        return downloadDataFromUrl(conn);
    }

    public static byte[] downloadDataFromUrl(HttpsURLConnection conn) throws IOException{
